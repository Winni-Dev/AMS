...
// import { HiBadgeCheck, HiEye, HiHeart, HiLightBulb, HiShieldCheck, HiUserGroup } from 'react-icons/hi'
...
//   const values = [
//     { icon: <HiShieldCheck className="text-4xl" />, title: t('about.values.transparency.title'), description: t('about.values.transparency.description') },
//     { icon: <HiHeart className="text-4xl" />, title: t('about.values.security.title'), description: t('about.values.security.description') },
//     { icon: <HiBadgeCheck className="text-4xl" />, title: t('about.values.reliability.title'), description: t('about.values.reliability.description') },
//     { icon: <HiLightBulb className="text-4xl" />, title: t('about.values.innovation.title'), description: t('about.values.innovation.description') },
//   ]

//   return (
//     <>
//       <Helmet>
//         <title>About AMS | Africa Med Supply - Our Mission & Vision</title>
//         <meta name="description" content="Learn about AMS's mission to connect European laboratories with African healthcare markets." />
//       </Helmet>
...
//           >
//             <span className="text-sm font-semibold tracking-wider uppercase text-health-green">{t('about.hero.badge')}</span>
...
//               viewport={{ once: true }}
//               className="p-10 bg-white rounded-3xl shadow-glass"
//             >
//               <HiEye className="mb-6 text-5xl text-health-green" />
//               <h2 className="mb-4 text-3xl font-bold font-sora text-deep-blue">{t('about.mission.title')}</h2>
//               <p className="text-lg leading-relaxed text-premium-gray">
...
//               whileInView={{ opacity: 1, x: 0 }}
//               viewport={{ once: true }}
//               className="p-10 text-white bg-deep-blue rounded-3xl shadow-glass"
//             >
//               <HiUserGroup className="mb-6 text-5xl text-health-green" />
//               <h2 className="mb-4 text-3xl font-bold font-sora">{t('about.vision.title')}</h2>
...
//       {/* Values */}
//       <section className="py-24 bg-gradient-to-b from-snow to-gray-50">
//         <div className="container px-4 mx-auto">
//           <motion.div
...
//           >
//             <span className="text-sm font-semibold tracking-wider uppercase text-health-green">{t('about.values.badge')}</span>
//             <h2 className="mt-4 text-4xl font-bold font-sora md:text-5xl text-deep-blue">{t('about.values.title')}</h2>
//           </motion.div>
...
//                 whileHover={{ y: -8 }}
//                 className="p-8 text-center transition-all duration-500 bg-white rounded-2xl shadow-glass hover:shadow-premium"
//               >
//                 <div className="flex justify-center mb-4 text-health-green">{value.icon}</div>
//                 <h3 className="mb-3 text-xl font-bold font-sora text-deep-blue">{value.title}</h3>
