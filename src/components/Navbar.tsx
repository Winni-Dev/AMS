    ...
    >
      <div className="container px-4 mx-auto">
        <div className="flex items-center justify-between h-16 md:h-20">
         ...
         {/* Logo - CERCLE BLANC MÊME TAILLE, LOGO PLUS GRAND */}
<Link 
  to="/" 
  className="flex-shrink-0 transition-transform duration-300 hover:scale-105"
>
  <div className="relative flex items-center justify-center w-12 h-12 bg-white rounded-full shadow-lg md:w-14 md:h-14 shadow-black/20 ring-2 ring-white/20">
    <img 
      src="/favicon.png" 
      alt="AMS Africa Med Supply" 
